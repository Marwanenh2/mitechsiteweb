document.addEventListener("DOMContentLoaded", function () {
    ...
    if (nav && navWrap) {
        navWrap.insertBefore(burger, navWrap.firstChild);
    ...
    // Fermer la barre éco
    const ecoClose = document.querySelector('.eco-close');
    const ecoBar = document.querySelector('.eco-bar');
    if (ecoClose && ecoBar) {
        ecoClose.addEventListener('click', function () {
            ecoBar.style.display = 'none';
        });
    }
